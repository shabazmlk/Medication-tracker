...
public class MainActivity extends AppCompatActivity
{
    ...
    */
    ...
    public  void onDialogOpenClick(MenuItem item)
    {
        currentPoints = getStoredPointsValue();
        ...
        // Set the score text
         textViewScore = dialog.findViewById(R.id.textViewScore);
        updatePointsDisplay();

        textViewScore.setText("Score: " + currentPoints);
    ...
    private void shareScoreDialog() {
        String message = "My Medicine Tracking Score is \uD83D\uDE00\uD83D\uDE00\uD83D\uDE00\uD83D\uDE00: " + currentPoints;
    ...
    public void onScoreShareClick(MenuItem item)
    {
        shareScoreDialog();
